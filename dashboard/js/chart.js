...
function preprocessData(data) {
    for (var i = 0; i < data.datasets.length; i++) {
        ...
        var lastIndex = dataPoints.slice().reverse().findIndex(value => value !== 0);
...
if (isDataEmpty(fireOccurrencesData)) {
    ...
    document.getElementById('linechart').innerHTML = "<h1 style='margin-top:25vh; margin-left:20vw;'>No Records Saved</h1>";
} else {
