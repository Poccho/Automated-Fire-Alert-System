...
const marker = L.marker([6.073838, 125.115167], { icon: fireDepartmentIcon }).addTo(map);
...
const initialTileLayer = addTileLayer("https://maps.geoapify.com/v1/tile/carto/{z}/{x}/{y}.png?&apiKey=2462cadf96ca47d9b4946aa91addde5d");

// Create alternate tile layer
const alternateTileLayer = addTileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}");
...
document.getElementById("switch-layers").addEventListener("click", switchTileLayer);
